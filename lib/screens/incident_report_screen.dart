                ...
                return AlertDialog(
                  ...
                  content: Column(
                    ...
                    children: [
                      ...
                      Text('${tr('incident_id_label')}: $incidentId'),
                      const SizedBox(height: 8),
                      Text(
                        tr('incident_report_success'),
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (value) {
                  if (value == null || value.isEmpty) {
                    return tr('enter_incident_title');
                  }
                  return null;
                },
              ),
              ...
              DropdownButtonFormField<String>(
                ...
                items: categories.map((String value) {
                  return DropdownMenuItem<String>(
                    value: value,
                    child: Text(_translateCategory(value)),
                  );
                }).toList(),
              ...
              DropdownButtonFormField<String>(
                ...
                items: urgencyLevels.map((String value) {
                  return DropdownMenuItem<String>(
                    value: value,
                    child: Text(tr(value.toLowerCase())),
                  );
                }).toList(),
                onChanged: (String? newValue) {
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            _locationAddress ?? tr('getting_location'),
  ...
  String _translateCategory(String value) {
    switch (value) {
      ...
      case 'Medical Emergency':
        return tr('medical_emergency');
      case 'Accident':
        return tr('accident');
      case 'Missing Person':
        return tr('missing_person');
      case 'Suspicious Activity':
        return tr('suspicious_activity');
      case 'Other':
      default:
        return tr('other');
    }
