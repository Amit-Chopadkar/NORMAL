        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 12),
              _buildEmergencyContact(tr('local_police_station'), '+91 2560 234567', Colors.indigo),
              const SizedBox(height: 32),
  ...
  void _showSOSDialog() {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text(tr('sos_alert')),
          content: Text(tr('sos_dialog_message')),
          actions: [
            TextButton(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text(tr('sos_sent'))),
                );
              },
              style: ElevatedButton.styleFrom(backgroundColor: Colors.red),
              child: Text(tr('send_sos')),
            ),
          ],
        );
      },
